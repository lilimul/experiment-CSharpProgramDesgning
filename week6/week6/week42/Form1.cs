...
namespace week42
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAddGoods_Click(object sender, EventArgs e)
        {
            ...
            addGoodsForm.FormClosed += new System.Windows.Forms.FormClosedEventHandler((s, evnt) =>
            {
                Console.WriteLine("Goods Added");
                this.goodsBindingSource.ResetBindings(false);
            });
            addGoodsForm.Show();
        }
    }
